...
const P4_DOTDIR: &'static str = ".p4";

/// Create a new Git backed repo.
#[derive(clap::Args, Clone, Debug)]
pub struct P4InfoArgs {
...
fn do_info(
    ...
    let colocated_git_repo_path = workspace_root.join(P4_DOTDIR);
    let init_mode = if colocate {
        ...
        if !git_repo_path.ends_with(P4_DOTDIR) {
            git_repo_path.push(P4_DOTDIR);
